...
public class PersonHandler {
    ...
    public String forLoop() {
        ...
        for (int x=0;x<personArray.length;x++){
            result+="\nMy first name is " + personArray[x].getFirstName()
                    +"\nMy last name is " + personArray[x].getLastName();
    ...
    public String forEachLoop() {
        ...
        for (Person each :personArray){
            result+="\nMy first name is " + each.getFirstName()
                    +"\nMy last name is " + each.getLastName();
